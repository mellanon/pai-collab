...
| [collab-bundle](projects/collab-bundle/) | @mellanon | building | CLI skill and tooling for pai-collab blackboard operations. **Specify complete** (20 features), repo scaffolded, F-1/F-2 implemented. |
