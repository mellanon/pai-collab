...
| [specflow-lifecycle](projects/specflow-lifecycle/) | @mellanon | hardening | Full lifecycle commands for SpecFlow — brownfield, review, release |
...
| [arc](projects/arc/) | @mellanon | proposed | Package management for PAI skills — npm transport, SkillSeal signing, Debian-style governance tiers |
